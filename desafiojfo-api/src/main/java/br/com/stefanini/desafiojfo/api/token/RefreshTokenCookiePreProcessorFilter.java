...
public class RefreshTokenCookiePreProcessorFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (req.getRequestURI().equalsIgnoreCase("/oauth/token")
			...
			req = new MyServletWrapper(req, refreshToken);
	...
	static class MyServletWrapper extends HttpServletRequestWrapper {

		private String refreshToken;

		public MyServletWrapper(HttpServletRequest request, String refreshToken) {
			super(request);
